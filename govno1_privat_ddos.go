...
func init() {
	...
	flag.StringVar(&method, "m", "GET PUT DELETE PATCH POST SLOW LOW HTTPS POWERSLOW  ULTRAPOWERSLOW ULTRAHTTPS ULTRAPING HTTPS2  ANTIDDOS далі йдуть боти (BOTDDOS ANTIDDOSBOT SUPERBOT SLOWLORISBOT SUPERULTIMATEBOT) Дальше ботнети (BOTNET_V2 BOTNET_V1 BOTNET_V3) Програму зробив @zemondza ", "method")
